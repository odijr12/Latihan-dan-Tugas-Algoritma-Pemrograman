...
int main(){
	...
	if(pil ==1){ 
		...
		for(c=0;c<=b;c++){
			...
			cout<<setw(2)<<c+1
			<<setw(8)<<buku[c].kodeB
			<<setw(22)<<buku[c].judul
			<<setw(10)<<buku[c].sewa
			<<setw(14)<<stok
			<<setw(17)<<pinjembuku[c].dipinjem;
			cout<<endl;
		}
		cout<<endl;
		system("pause");
		...
		system("cls");
			...
			for(g=0;g<=b;g++){ 
				if(pinjembuku[g].kB==buku[g].kodeB){
					cout<<setw(2)<<g+1
					<<setw(10)<<pinjembuku[g].kodepinjam
					<<setw(13)<<buku[g].judul
					<<setw(12)<<pinjembuku[g].namap
					<<setw(14)<<pinjembuku[g].alamat
					<<setw(20)<<pinjembuku[g].tglpin
					<<setw(10)<<pinjembuku[g].tglbalik
